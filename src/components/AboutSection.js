  ...
  return (
    <section style={{ "font-family": "Karla" }} className="w-full ">
      <section className="flex max-w-[1400px] m-auto px-10 mb-2 py-10 justify-between ">
        ...
        <section className="hidden md:flex self-center">
          <img
            src={require("../assets/icons_assets/Mario and Adrian A.jpg")}
            className="min-w-[10rem] w-[14rem] rounded-[5px] relative translate-y-16 translate-x-16 z-10"
            alt="restaurant food"
          />
          <img
            src={require("../assets/icons_assets/Mario and Adrian b.jpg")}
            className="min-w-[10rem] w-[14rem] relative rounded-[5px] z-0"
            alt="restaurant food"
          />
        </section>
      </section>
